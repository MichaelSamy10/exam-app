...
import QuestionsSkeleton from '../_skeletons/questions-skeleton';
...
export default function QuestionCard() {
  ...
  const durationMinutes =
    data?.questions?.[0]?.exam?.duration || 0;
            ...
            <div className="mt-10">
              ...
              >
                {currentQuestion?.answers.map(item => (
                  <div
                    key={item.key}
                    className="flex gap-3 bg-gray-50 p-4 text-gray-800 hover:bg-gray-100"
              ...
              <div className="mt-12 flex w-full items-center justify-between gap-2">
                ...
                <div className="relative me-4 ms-4 flex items-center justify-center">
                  <CircularProgress
                    value={timerProgress}
                    size={80}
                    strokeWidth={12}
